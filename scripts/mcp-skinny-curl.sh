...
#
# Usage:
#   ./scripts/mcp-curl.sh initialize
#   ./scripts/mcp-curl.sh tools-list
#   ./scripts/mcp-curl.sh tools-call <number> [requestedBy]
#   ./scripts/mcp-curl.sh ping
#
# Optional env:
#   MCP_BASE_URL  default http://localhost:3001/mcp

set -euo pipefail

MCP_BASE_URL="${MCP_BASE_URL:-http://localhost:3001/mcp}"
...
Environment:
  MCP_BASE_URL   MCP POST endpoint (default: http://localhost:3001/mcp)
EOF
}
